...
public class OrderItemServiceImpl implements OrderItemService {
	 ...
	 */
	@Override
	public PageResult<TbOrderItem> findPage(int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		Page<TbOrderItem> page = (Page<TbOrderItem>) orderItemMapper.selectByExample(null);
		return new PageResult<TbOrderItem>(page.getTotal(), page.getResult());
	}
	...
	@Override
	public PageResult<TbOrderItem> findPage(TbOrderItem orderItem, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
