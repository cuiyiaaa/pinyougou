...
public class GoodsDescServiceImpl implements GoodsDescService {
	 ...
	 */
	@Override
	public PageResult<TbGoodsDesc> findPage(int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);		
		Page<TbGoodsDesc> page=   (Page<TbGoodsDesc>) goodsDescMapper.selectByExample(null);
		return new PageResult<TbGoodsDesc>(page.getTotal(), page.getResult());
	}
	...
	public void delete(Long[] ids) {
		...
		@Override
	public PageResult<TbGoodsDesc> findPage(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
