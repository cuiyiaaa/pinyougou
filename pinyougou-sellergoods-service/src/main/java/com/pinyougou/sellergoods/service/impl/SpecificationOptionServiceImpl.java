...
public class SpecificationOptionServiceImpl implements SpecificationOptionService {
	 ...
	 */
	@Override
	public PageResult<TbSpecificationOption> findPage(int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		Page<TbSpecificationOption> page = (Page<TbSpecificationOption>) specificationOptionMapper
				.selectByExample(null);
		return new PageResult<TbSpecificationOption>(page.getTotal(), page.getResult());
	}
	...
	@Override
	public PageResult<TbSpecificationOption> findPage(TbSpecificationOption specificationOption, int pageNum,
			int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
