...
public class ItemServiceImpl implements ItemService {
	 ...
	 */
	@Override
	public PageResult<TbItem> findPage(int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		Page<TbItem> page = (Page<TbItem>) itemMapper.selectByExample(null);
		return new PageResult<TbItem>(page.getTotal(), page.getResult());
	}
	...
	@Override
	public PageResult<TbItem> findPage(TbItem item, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
